...
ap.add_argument("-i", 'suriya.jpg', required=True, help="/Users/harisuriya/Desktop/documents")
args = vars(ap.parse_args())

# load the input image, resize it, and convert it to grayscale
image = cv2.imread(args['suriya.jpg'])
